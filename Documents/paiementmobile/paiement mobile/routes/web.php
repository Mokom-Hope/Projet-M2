...
// Payment callbacks
// Route::post('/payment/callback/notchpay', [PaymentCallbackController::class, 'notchpayCallback'])->name('payment.callback');
// Route::get('/payment/return', [PaymentCallbackController::class, 'paymentReturn'])->name('payment.return');
...
// Transfer routes
Route::middleware('auth')->group(function () {
    Route::get('/transfers/{transfer}/check-payment', [TransferController::class, 'checkPaymentStatus'])->name('transfers.check-payment');
});
