                    ...
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            <input id="transfer_code" name="transfer_code" type="text" required 
                                   ...
                                   placeholder="XXXXXXXX" value="{{ $transferCode ?? old('transfer_code') }}" maxlength="8" style="text-transform: uppercase;">
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label for="payment_method_id" class="block text-sm font-semibold text-gray-700 mb-2">
                                        Comment souhaitez-vous recevoir l'argent ?
                                    </label>
...
function checkTransferCode() {
    ...
    // Simulate API call to check transfer code
    fetch(`{{ route('transfers.info') }}?transfer_code=${code}`)
        ...
        .then(data => {
            if (data.success) {
                ...
                document.getElementById('transferAmount').textContent = `${data.data.amount} ${data.data.currency}`;
