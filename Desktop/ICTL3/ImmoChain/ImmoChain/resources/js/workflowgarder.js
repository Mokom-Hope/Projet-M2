...
console.log('Workflow script loaded');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('workflowButton:', workflowButton);
    console.log('workflowMenu:', workflowMenu);
    console.log('scanQRButton:', scanQRButton);
    console.log('qrScannerModal:', qrScannerModal);
    console.log('qrCodeModal:', qrCodeModal);
    console.log('closeQRScannerButton:', closeQRScannerButton);
    console.log('closeQRCodeButton:', closeQRCodeButton);
    console.log('missionsList:', missionsList);


    workflowButton.addEventListener('click', toggleWorkflowMenu);
    workflowButton.addEventListener('touchstart', function(e) {
        e.preventDefault(); // Empêche le double déclenchement sur certains appareils
        toggleWorkflowMenu();
    });
