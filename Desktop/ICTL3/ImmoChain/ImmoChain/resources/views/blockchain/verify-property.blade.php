...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-6">Vérification Blockchain du Bien Immobilier</h1>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden mb-8">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <p class="text-gray-700 mb-2"><span class="font-semibold">ID:</span> {{ $property->id }}</p>
                    <p class="text-gray-700 mb-2"><span class="font-semibold">Titre:</span> {{ $property->titre }}</p>
                    <p class="text-gray-700 mb-2"><span class="font-semibold">Type:</span> {{ $property->type }}</p>
                    <p class="text-gray-700 mb-2"><span class="font-semibold">Adresse:</span> {{ $property->adresse }}</p>
                </div>
                <div>
                    <p class="text-gray-700 mb-2"><span class="font-semibold">Prix:</span> {{ number_format($property->prix, 0, ',', ' ') }} FCFA</p>
                    <p class="text-gray-700 mb-2"><span class="font-semibold">Superficie:</span> {{ $property->superficie }} m²</p>
                    <p class="text-gray-700 mb-2"><span class="font-semibold">Statut:</span> {{ $property->statut }}</p>
                    <p class="text-gray-700 mb-2"><span class="font-semibold">Date de création:</span> {{ $property->created_at->format('d/m/Y H:i:s') }}</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden mb-8">
            ...
            <div class="p-6">
                <p class="text-gray-700 mb-4">
                    Ce bien immobilier est certifié sur la blockchain ImmoChain. Les informations suivantes ont été enregistrées de manière sécurisée et immuable.
                </p>
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden mb-8">
            <div class="px-6 py-4 bg-red-50 border-b border-red-200">
                <h2 class="text-xl font-semibold text-red-800">
                    ...
                    Non Certifié sur la Blockchain
                </h2>
            </div>
            <div class="p-6">
                <p class="text-gray-700 mb-4">
                    Ce bien immobilier n'est pas encore certifié sur la blockchain ImmoChain.
                </p>
            </div>
        </div>
    @endif
